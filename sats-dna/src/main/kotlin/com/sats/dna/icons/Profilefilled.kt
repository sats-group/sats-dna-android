    ...
    get() {
        ...
        _profilefilled = materialIcon(name = "Profilefilled") {
            path(
                ...
                curveToRelative(0f, -2.26f, -1.69f, -4.11f, -3.83f, -4.11f)
                reflectiveCurveToRelative(-3.84f, 1.85f, -3.82f, 4.1f)
                close()
                moveTo(23.44f, 12f)
                curveToRelative(0f, 6.25f, -5.2f, 11.43f, -11.45f, 11.43f)
                curveToRelative(-6.23f, 0f, -11.43f, -5.18f, -11.43f, -11.43f)
                reflectiveCurveTo(5.74f, 0.57f, 11.98f, 0.57f)
                ...
                curveToRelative(-2.97f, 0f, -5.77f, 1.21f, -6.97f, 3.07f)
                close()
            }
        }
