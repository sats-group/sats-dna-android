    ...
    get() {
        ...
        _treatments = materialIcon(name = "Treatments") {
            path(
                ...
                lineToRelative(2.57f, 1.14f)
                curveToRelative(1.43f, 0.57f, 0.93f, 2.14f, -0.63f, 1.51f)
                curveToRelative(-1.56f, -0.63f, -4.12f, -1.6f, -4.22f, -1.7f)
                ...
                curveToRelative(0.09f, -0.06f, -1.8f, -1.82f, -1.8f, -1.82f)
                moveToRelative(-2.64f, -1f)
                lineToRelative(1.32f, -0.07f)
                moveToRelative(9.25f, 10.21f)
                ...
                curveToRelative(0f, -0.67f, -0.03f, -1.21f, -0.03f, -1.9f)
                lineToRelative(0.03f, -2.18f)
                curveToRelative(0f, -0.34f, 0.84f, -3.14f, 0.97f, -3.43f)
                curveToRelative(0.13f, -0.3f, 0.58f, 0f, 0.86f, -0.86f)
                curveToRelative(0.16f, -0.48f, -0.47f, -0.99f, -0.47f, -0.99f)
                curveToRelative(0.06f, -0.23f, 0.68f, -2.04f, 1.02f, -3.06f)
                ...
                reflectiveCurveToRelative(-2.11f, -0.94f, -2.11f, -2.1f)
                curveToRelative(0f, -1.18f, 0.94f, -2.12f, 2.11f, -2.12f)
                reflectiveCurveToRelative(2.11f, 0.94f, 2.11f, 2.11f)
                close()
                moveTo(12.35f, 2.7f)
                curveToRelative(0f, 1.16f, -0.94f, 2.1f, -2.11f, 2.1f)
                reflectiveCurveTo(8.13f, 3.86f, 8.13f, 2.7f)
                curveToRelative(0f, -1.17f, 0.94f, -2.12f, 2.1f, -2.12f)
                curveToRelative(1.18f, 0f, 2.12f, 0.95f, 2.12f, 2.12f)
                close()
            }
        }
