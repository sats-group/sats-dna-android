    ...
    get() {
        ...
        _recruitFriends = materialIcon(name = "RecruitFriends") {
            path(
                ...
                curveToRelative(0.07f, -0.09f, 0.12f, -0.2f, 0.14f, -0.3f)
                lineTo(16f, 12.55f)
                ...
                curveToRelative(0.18f, -0.45f, 0.46f, -0.85f, 0.8f, -1.18f)
                curveToRelative(0.35f, -0.34f, 0.76f, -0.6f, 1.21f, -0.78f)
                curveToRelative(0.46f, -0.17f, 0.94f, -0.26f, 1.42f, -0.24f)
                curveToRelative(0.95f, 0.05f, 1.85f, 0.47f, 2.5f, 1.18f)
                curveToRelative(0.65f, 0.7f, 1f, 1.62f, 1f, 2.58f)
                ...
                curveToRelative(0.07f, 0.1f, 0.17f, 0.16f, 0.29f, 0.19f)
            ...
            path(
                ...
                moveTo(11.38f, 10.55f)
                lineToRelative(-2.3f, -0.66f)
                curveTo(9f, 9.87f, 8.93f, 9.82f, 8.87f, 9.75f)
                curveTo(8.8f, 9.7f, 8.76f, 9.6f, 8.76f, 9.51f)
                ...
                curveToRelative(-0.51f, -0.54f, -1.2f, -0.86f, -1.95f, -0.9f)
                ...
                curveTo(4.67f, 3.47f, 4.6f, 3.84f, 4.6f, 4.22f)
                verticalLineToRelative(1.4f)
                curveToRelative(0f, 0.53f, 0.15f, 1.05f, 0.44f, 1.5f)
                curveToRelative(0.3f, 0.45f, 0.7f, 0.81f, 1.2f, 1.03f)
                lineToRelative(-0.2f, 1.36f)
