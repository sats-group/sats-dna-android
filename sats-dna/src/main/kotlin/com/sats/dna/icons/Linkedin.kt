    ...
    get() {
        ...
        _linkedin = materialIcon(name = "Linkedin") {
            path(
                ...
                curveToRelative(0.22f, 0f, 0.42f, -0.09f, 0.57f, -0.24f)
                ...
                curveToRelative(-0.2f, 0f, -0.41f, -0.06f, -0.59f, -0.18f)
                ...
                curveToRelative(0f, 0.14f, -0.03f, 0.28f, -0.09f, 0.4f)
                ...
                curveToRelative(0.17f, -0.3f, 0.42f, -0.55f, 0.73f, -0.72f)
                curveToRelative(0.3f, -0.16f, 0.64f, -0.25f, 0.98f, -0.23f)
                curveToRelative(1.83f, 0f, 2.17f, 1.2f, 2.17f, 2.76f)
