    ...
    get() {
        ...
        _pt = materialIcon(name = "Pt") {
            path(
                ...
                curveToRelative(0.03f, 0.34f, 0.19f, 0.65f, 0.44f, 0.87f)
                curveToRelative(0.25f, 0.21f, 0.58f, 0.32f, 0.9f, 0.29f)
                ...
                lineToRelative(2.49f, 3.61f)
                curveToRelative(0.21f, 0.26f, 0.51f, 0.42f, 0.84f, 0.46f)
                curveToRelative(0.33f, 0.03f, 0.66f, -0.08f, 0.91f, -0.3f)
