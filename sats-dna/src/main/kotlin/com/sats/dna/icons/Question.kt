    ...
    get() {
        ...
        _question = materialIcon(name = "Question") {
            path(
                ...
                curveToRelative(-0.22f, 0.12f, -0.44f, 0.26f, -0.63f, 0.42f)
                curveToRelative(-0.36f, 0.3f, -0.9f, 0.33f, -1.24f, 0f)
                curveToRelative(-0.28f, -0.29f, -0.3f, -0.75f, 0f, -1.02f)
                curveTo(9.1f, 7.14f, 9.53f, 6.84f, 10f, 6.6f)
