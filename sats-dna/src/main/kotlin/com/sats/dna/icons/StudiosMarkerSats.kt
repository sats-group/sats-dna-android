    ...
    get() {
        ...
        _studiosMarkerSats = materialIcon(name = "StudiosMarkerSats") {
            path(
                ...
                curveToRelative(0.53f, 0.67f, 1.28f, 1.08f, 2.1f, 1.08f)
                curveToRelative(1.06f, 0f, 1.46f, -0.59f, 1.46f, -1.13f)
                curveToRelative(0f, -0.4f, -0.22f, -0.67f, -0.7f, -1.12f)
                lineToRelative(-0.7f, -0.67f)
                curveToRelative(-0.75f, -0.67f, -1.32f, -1.4f, -1.32f, -2.42f)
                curveToRelative(0f, -2.11f, 1.75f, -3.73f, 4.12f, -3.73f)
                ...
                curveToRelative(0.7f, 0.63f, 1.37f, 1.3f, 1.37f, 2.42f)
