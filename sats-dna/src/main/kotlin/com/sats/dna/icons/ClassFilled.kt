...
val SatsIcons.ClassFilled: ImageVector
    get() {
        if (_classFilled != null) {
            return _classFilled!!
        }

        _classFilled = materialIcon(name = "ClassFilled") {
            path(
            ...
            path(
                ...
                curveToRelative(0.38f, 0.24f, 0.87f, 0.14f, 1.12f, -0.23f)
                lineTo(9.5f, 7.96f)
                ...
                curveToRelative(0.09f, -0.08f, 0.16f, -0.18f, 0.2f, -0.3f)
...
private var _classFilled: ImageVector? = null

@Preview
@Composable
private fun SatsIconClassFilledPreview() {
    Icon(SatsIcons.ClassFilled, contentDescription = null)
}
