    ...
    get() {
        ...
        _openFolder = materialIcon(name = "OpenFolder") {
            ...
            path(
                ...
                curveToRelative(0.25f, 0f, 0.48f, 0.12f, 0.62f, 0.33f)
                curveToRelative(0.14f, 0.2f, 0.17f, 0.46f, 0.08f, 0.69f)
                lineToRelative(-3.53f, 9.42f)
                curveToRelative(-0.11f, 0.3f, -0.4f, 0.5f, -0.7f, 0.5f)
                horizontalLineTo(4.33f)
                curveToRelative(-0.25f, 0f, -0.48f, -0.13f, -0.62f, -0.33f)
