    ...
    get() {
        ...
        _nutrition = materialIcon(name = "Nutrition") {
            path(
                ...
                curveToRelative(1.54f, -0.4f, 3.03f, 0.07f, 4.02f, 1f)
                curveToRelative(0.98f, 0.94f, 1.46f, 2.36f, 0.93f, 3.82f)
                ...
                curveToRelative(-0.63f, 0.2f, -1.3f, 0.17f, -1.9f, -0.1f)
                curveToRelative(-0.61f, -0.28f, -1.09f, -0.77f, -1.35f, -1.38f)
                lineToRelative(-0.01f, -0.03f)
                lineToRelative(-1.25f, -3.4f)
                curveToRelative(-0.53f, -1.46f, -0.05f, -2.89f, 0.94f, -3.82f)
                close()
                moveToRelative(0.24f, 3.39f)
                lineToRelative(1.25f, 3.39f)
                curveToRelative(0.14f, 0.31f, 0.38f, 0.56f, 0.7f, 0.7f)
                curveToRelative(0.32f, 0.15f, 0.68f, 0.17f, 1f, 0.06f)
                horizontalLineToRelative(0.02f)
                lineToRelative(1.08f, -0.33f)
                curveToRelative(0.12f, -0.04f, 0.25f, -0.04f, 0.37f, 0f)
                lineToRelative(1.1f, 0.33f)
                curveToRelative(0.32f, 0.11f, 0.68f, 0.1f, 1f, -0.05f)
                curveToRelative(0.32f, -0.14f, 0.57f, -0.4f, 0.7f, -0.71f)
                lineToRelative(1.25f, -3.39f)
            ...
            path(
                ...
                curveToRelative(0.35f, 0f, 0.63f, 0.28f, 0.63f, 0.63f)
                reflectiveCurveToRelative(-0.28f, 0.62f, -0.63f, 0.62f)
                horizontalLineTo(6.37f)
                curveToRelative(-0.34f, 0f, -0.62f, -0.27f, -0.62f, -0.62f)
                close()
            }
        }
