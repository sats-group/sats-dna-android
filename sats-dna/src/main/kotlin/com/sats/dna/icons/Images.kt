    ...
    get() {
        ...
        _images = materialIcon(name = "Images") {
            path(
                ...
                curveToRelative(-0.16f, -0.15f, -0.33f, -0.26f, -0.5f, -0.34f)
                curveToRelative(-0.18f, -0.07f, -0.35f, -0.1f, -0.53f, -0.1f)
                ...
                curveToRelative(-0.44f, -0.42f, -1.09f, -0.64f, -1.95f, -0.64f)
