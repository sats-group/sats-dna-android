    ...
    get() {
        ...
        _spotify = materialIcon(name = "Spotify") {
            path(
                ...
                curveToRelative(3.45f, 0f, 6.26f, -2.82f, 6.26f, -6.27f)
                curveToRelative(0f, -3.44f, -2.77f, -6.26f, -6.26f, -6.26f)
                close()
                ...
                curveToRelative(-1.69f, -1.02f, -4.27f, -1.33f, -6.22f, -0.7f)
                ...
                curveToRelative(-0.31f, 0.07f, -0.62f, -0.08f, -0.7f, -0.4f)
                curveToRelative(-0.08f, -0.3f, 0.08f, -0.62f, 0.39f, -0.7f)
                curveToRelative(2.23f, -0.67f, 5.87f, -0.55f, 8.22f, 0.86f)
                curveToRelative(0.27f, 0.16f, 0.39f, 0.55f, 0.23f, 0.82f)
