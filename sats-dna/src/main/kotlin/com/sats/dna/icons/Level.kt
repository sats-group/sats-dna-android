    ...
    get() {
        ...
        _level = materialIcon(name = "Level") {
            path(
                ...
                curveToRelative(0f, -0.1f, 0f, -0.21f, -0.05f, -0.3f)
                curveToRelative(-0.03f, -0.1f, -0.1f, -0.2f, -0.17f, -0.27f)
                curveToRelative(-0.07f, -0.08f, -0.16f, -0.14f, -0.26f, -0.17f)
            ...
            path(
                ...
                curveTo(9.8f, 8.75f, 9.7f, 8.76f, 9.6f, 8.8f)
                curveTo(9.5f, 8.84f, 9.4f, 8.9f, 9.34f, 8.97f)
                reflectiveCurveTo(9.21f, 9.13f, 9.17f, 9.23f)
                curveToRelative(-0.04f, 0.1f, -0.05f, 0.2f, -0.05f, 0.31f)
                verticalLineToRelative(9.5f)
                curveToRelative(0f, 0.1f, 0.01f, 0.21f, 0.05f, 0.31f)
                reflectiveCurveToRelative(0.1f, 0.19f, 0.17f, 0.26f)
                curveToRelative(0.08f, 0.08f, 0.17f, 0.14f, 0.27f, 0.18f)
                curveToRelative(0.1f, 0.03f, 0.2f, 0.05f, 0.3f, 0.04f)
                horizontalLineToRelative(3.17f)
                curveToRelative(0.1f, 0f, 0.21f, 0f, 0.31f, -0.04f)
                reflectiveCurveToRelative(0.2f, -0.1f, 0.27f, -0.18f)
