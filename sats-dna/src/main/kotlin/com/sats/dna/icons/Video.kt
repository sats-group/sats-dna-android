    ...
    get() {
        ...
        _video = materialIcon(name = "Video") {
            path(
                ...
                verticalLineToRelative(1.5f)
                curveToRelative(1.31f, 0f, 2.38f, -1.07f, 2.38f, -2.4f)
                horizontalLineToRelative(-1.5f)
                close()
                ...
                close()
                moveToRelative(-9f, 0f)
                curveToRelative(-0.5f, 0f, -0.89f, -0.4f, -0.89f, -0.9f)
                horizontalLineToRelative(-1.5f)
                curveToRelative(0f, 1.33f, 1.07f, 2.4f, 2.39f, 2.4f)
                verticalLineToRelative(-1.5f)
                close()
                moveToRelative(-0.89f, -0.9f)
                verticalLineTo(7.1f)
                horizontalLineToRelative(-1.5f)
                verticalLineToRelative(9.8f)
                horizontalLineToRelative(1.5f)
                close()
                moveToRelative(0f, -9.8f)
                curveToRelative(0f, -0.5f, 0.4f, -0.9f, 0.89f, -0.9f)
                verticalLineTo(4.7f)
