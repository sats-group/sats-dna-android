    ...
    get() {
        ...
        _quinyx = materialIcon(name = "Quinyx") {
            path(
                ...
                curveToRelative(-0.38f, -0.92f, -0.6f, -1.88f, -0.68f, -2.86f)
                horizontalLineToRelative(9.35f)
                curveToRelative(1.21f, 0f, 2.4f, 0.24f, 3.53f, 0.7f)
                curveToRelative(1.11f, 0.46f, 2.13f, 1.14f, 2.98f, 2f)
                curveToRelative(0.86f, 0.85f, 1.53f, 1.86f, 2f, 2.98f)
                curveToRelative(0.37f, 0.91f, 0.6f, 1.87f, 0.67f, 2.86f)
                horizontalLineToRelative(-9.35f)
                close()
            }
            ...
            path(
                ...
                curveToRelative(0.6f, -1.88f, 1.8f, -3.52f, 3.4f, -4.69f)
                curveTo(8.2f, 2.8f, 10.5f, 2.2f, 12.8f, 2.43f)
