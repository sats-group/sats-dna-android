    ...
    get() {
        ...
        _refresh = materialIcon(name = "Refresh") {
            path(
                ...
                curveToRelative(1.42f, 0.91f, 3.12f, 1.29f, 4.8f, 1.05f)
                ...
                curveToRelative(-1.68f, -1.08f, -2.9f, -2.74f, -3.47f, -4.66f)
                curveToRelative(-0.56f, -1.91f, -0.4f, -3.97f, 0.42f, -5.79f)
            ...
            path(
                ...
                curveToRelative(-0.82f, 1.8f, -0.97f, 3.82f, -0.42f, 5.71f)
                curveToRelative(0.56f, 1.9f, 1.77f, 3.53f, 3.43f, 4.6f)
                ...
                curveToRelative(-1.12f, 1.3f, -2.67f, 2.14f, -4.37f, 2.38f)
                curveToRelative(-1.7f, 0.25f, -3.42f, -0.13f, -4.86f, -1.06f)
                ...
                curveToRelative(-1.06f, -1.67f, -2.69f, -2.9f, -4.58f, -3.45f)
                close()
            }
            ...
            path(
                ...
                reflectiveCurveToRelative(0.76f, 0.34f, 0.76f, 0.75f)
                verticalLineToRelative(4.72f)
                curveToRelative(0f, 0.41f, -0.34f, 0.75f, -0.76f, 0.75f)
                horizontalLineToRelative(-4.71f)
