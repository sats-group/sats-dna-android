    ...
    get() {
        ...
        _smallgroup = materialIcon(name = "Smallgroup") {
            path(
                ...
                moveTo(12.03f, 12.5f)
                curveToRelative(1.76f, 0f, 3.18f, -1.43f, 3.18f, -3.18f)
                curveToRelative(0f, -1.76f, -1.42f, -3.18f, -3.18f, -3.18f)
            ...
            path(
                ...
                curveToRelative(0f, -1.76f, 1.42f, -3.18f, 3.18f, -3.18f)
                curveToRelative(1.2f, 0f, 2.24f, 0.66f, 2.78f, 1.64f)
            }
            ...
            path(
                ...
                moveTo(0.75f, 18.13f)
                reflectiveCurveToRelative(0.85f, -5.41f, 2.16f, -5.96f)
                curveToRelative(0.65f, -0.26f, 2.4f, -0.4f, 4.17f, -0.4f)
            }
