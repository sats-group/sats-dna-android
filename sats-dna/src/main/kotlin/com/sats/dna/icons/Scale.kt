    ...
    get() {
        ...
        _scale = materialIcon(name = "Scale") {
            ...
            path(
                ...
                moveTo(13.1f, 7.6f)
                curveToRelative(0.37f, 0.1f, 0.6f, 0.48f, 0.5f, 0.85f)
                lineToRelative(-0.92f, 3.72f)
                curveToRelative(-0.1f, 0.37f, -0.48f, 0.6f, -0.85f, 0.5f)
                curveToRelative(-0.37f, -0.09f, -0.6f, -0.46f, -0.5f, -0.84f)
                lineToRelative(0.92f, -3.72f)
                curveToRelative(0.1f, -0.37f, 0.48f, -0.6f, 0.85f, -0.5f)
                close()
            }
            ...
            path(
                ...
                curveTo(8.41f, 5.77f, 7.62f, 6.3f, 6.96f, 6.96f)
                curveTo(6.29f, 7.62f, 5.77f, 8.4f, 5.4f, 9.27f)
                ...
                curveToRelative(-0.36f, -0.87f, -0.88f, -1.65f, -1.55f, -2.31f)
                ...
                curveToRelative(-0.22f, 0.53f, -0.35f, 1.1f, -0.41f, 1.66f)
                horizontalLineToRelative(11.76f)
                curveToRelative(-0.06f, -0.57f, -0.2f, -1.13f, -0.41f, -1.66f)
