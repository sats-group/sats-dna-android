    ...
    get() {
        ...
        _sats = materialIcon(name = "Sats") {
            path(
                ...
                curveToRelative(-0.6f, -0.52f, -0.93f, -0.94f, -0.93f, -1.53f)
                curveToRelative(0f, -0.74f, 0.52f, -1.4f, 1.63f, -1.4f)
                ...
                lineToRelative(1f, 0.88f)
                curveToRelative(0.7f, 0.63f, 0.98f, 1.02f, 0.98f, 1.56f)
                curveToRelative(0f, 0.82f, -0.56f, 1.6f, -1.98f, 1.6f)
                curveToRelative(-1.04f, 0f, -1.98f, -0.43f, -2.68f, -1.25f)
