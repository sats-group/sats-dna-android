    ...
    get() {
        ...
        _distance = materialIcon(name = "Distance") {
            path(
                ...
                curveToRelative(0f, 1.12f, 0.45f, 2.2f, 1.26f, 3f)
                curveToRelative(0.8f, 0.78f, 1.9f, 1.23f, 3.05f, 1.23f)
                curveToRelative(0.33f, 0f, 0.6f, 0.27f, 0.6f, 0.6f)
            ...
            path(
                ...
                curveToRelative(0.28f, 0.5f, 0.67f, 1.02f, 1.07f, 1.5f)
                curveToRelative(0.4f, 0.47f, 0.8f, 0.9f, 1.09f, 1.2f)
                lineToRelative(0.08f, 0.09f)
                lineToRelative(0.08f, -0.09f)
                curveToRelative(0.3f, -0.3f, 0.7f, -0.73f, 1.1f, -1.2f)
                ...
                curveToRelative(0.72f, 0.71f, 1.14f, 1.68f, 1.14f, 2.7f)
