    ...
    get() {
        ...
        _appIconS = materialIcon(name = "AppIconS") {
            path(
                ...
                curveToRelative(0f, -1.76f, 0.17f, -2.96f, 1f, -3.78f)
            ...
            path(
                ...
                curveTo(16.46f, 7f, 15.38f, 6.3f, 13.8f, 6.3f)
                curveToRelative(-2.33f, 0f, -4.03f, 1.58f, -4.03f, 3.66f)
                curveToRelative(0f, 1.05f, 0.55f, 1.77f, 1.28f, 2.42f)
                lineTo(11.76f, 13f)
                ...
                curveToRelative(2.64f, 0f, 4.17f, -1.66f, 4.17f, -3.84f)
