    ...
    get() {
        ...
        _profile = materialIcon(name = "Profile") {
            path(
                ...
                curveToRelative(1.19f, -1.85f, 3.98f, -3.06f, 6.94f, -3.06f)
                curveToRelative(2.93f, 0f, 5.7f, 1.2f, 6.9f, 3.06f)
                lineToRelative(0.3f, 0.41f)
                lineToRelative(0.72f, -1.1f)
                ...
                curveToRelative(-2.3f, 0.43f, -4.31f, 1.52f, -5.46f, 3.31f)
                close()
                moveToRelative(4f, -8.23f)
                curveToRelative(0f, 2.39f, 1.67f, 4.15f, 3.8f, 4.18f)
                curveToRelative(2.14f, 0.03f, 3.82f, -1.8f, 3.82f, -4.18f)
                curveToRelative(0f, -2.24f, -1.68f, -4.1f, -3.82f, -4.1f)
                curveToRelative(-2.13f, 0f, -3.82f, 1.86f, -3.8f, 4.1f)
                close()
            }
