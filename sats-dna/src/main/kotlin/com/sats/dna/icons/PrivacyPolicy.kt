    ...
    get() {
        ...
        _privacyPolicy = materialIcon(name = "PrivacyPolicy") {
            path(
                ...
                curveToRelative(-0.67f, 0.68f, -1.59f, 1.05f, -2.55f, 1.05f)
                curveToRelative(-0.95f, 0f, -1.87f, -0.37f, -2.55f, -1.05f)
                lineTo(6.6f, 9.5f)
                lineToRelative(4.44f, -4.44f)
                curveToRelative(1.2f, -1.2f, 2.82f, -1.87f, 4.51f, -1.87f)
                curveToRelative(1.7f, 0f, 3.31f, 0.68f, 4.5f, 1.87f)
                verticalLineToRelative(0f)
                curveToRelative(1.01f, 1f, 1.65f, 2.32f, 1.83f, 3.72f)
            ...
            path(
                ...
                curveToRelative(0.5f, 0.51f, 0.8f, 1.2f, 0.8f, 1.92f)
                curveToRelative(0f, 0.71f, -0.3f, 1.4f, -0.8f, 1.9f)
                lineToRelative(-1.47f, 1.48f)
                curveToRelative(-0.5f, 0.5f, -1.1f, 0.9f, -1.76f, 1.18f)
                curveToRelative(-0.66f, 0.27f, -1.36f, 0.4f, -2.07f, 0.4f)
                curveToRelative(-0.71f, 0f, -1.41f, -0.13f, -2.07f, -0.4f)
                curveToRelative(-0.66f, -0.28f, -1.25f, -0.68f, -1.75f, -1.18f)
                lineTo(3.95f, 14.1f)
                curveToRelative(-1.2f, -1.2f, -1.87f, -2.82f, -1.87f, -4.51f)
                curveToRelative(0f, -1.7f, 0.67f, -3.31f, 1.87f, -4.5f)
                verticalLineToRelative(0f)
                curveToRelative(1.18f, -1.2f, 2.77f, -1.86f, 4.44f, -1.88f)
            }
